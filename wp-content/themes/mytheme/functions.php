...
require ZAKRA_PARENT_INC_DIR . '/class-dynamic-filter.php';
require ZAKRA_PARENT_INC_DIR . '/template-tags.php';
require ZAKRA_PARENT_INC_DIR . '/template-functions.php';
require ZAKRA_PARENT_INC_DIR . '/customizer/class-customizer.php';
require ZAKRA_PARENT_INC_DIR . '/class-css-classes.php';
require ZAKRA_PARENT_INC_DIR . '/class-dynamic-css.php';
require ZAKRA_PARENT_INC_DIR . '/class-migration.php';;
...
function getUserEmail_func($firstname ,$lastname) {
    $firstname = 'gayatri';
	$lastname='kumbhar';
...
switch( $atts['type'] ){
    case 'firstname': 
        $output = '<div class="shortcodecontent">Gayatri</div>';
        break;

    case 'middlename': 
        $output = '<div class="othershortcodecontent">Vivek</div>';
        break;

   
    case 'lastname': 
        $output = '<div class="defaultshortcodecontent">Kumbhar</div>';
        break;
}
